...
public class Main {
    public static void main(String[] args) {
            ...
            mediaTraining MediaTraining = mediaTraining.getInstance();
            double mediaFormare = MediaTraining.calculeazaMedieTraining(cursuriFormare);
            ...
            mediaAngajati MediaAngajati = mediaAngajati.getInstance();
            double mediaAngajatiTotala = MediaAngajati.calculeazaMedieAngajati(listaAngajati);
            System.out.println("Media notelor tuturor angajatilor: " + mediaAngajatiTotala);
